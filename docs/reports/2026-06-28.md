...
Generated: 2026-06-28T10:16:15Z
...
- Brazil: 74.1% (-1.3 pts vs previous run)
- Norway: 54.4% (-0.2 pts vs previous run)
- Ivory Coast: 45.6% (+0.2 pts vs previous run)
- Japan: 25.9% (+1.3 pts vs previous run)
